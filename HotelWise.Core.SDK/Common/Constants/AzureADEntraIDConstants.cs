...
/// </summary>
[SdkWrappedSource(targetType: "SmartCoreHub.Core.SDK.Service.Configuration.AzureADEntraIDConstants", targetPackage: "SmartCoreHub.Core.SDK", description: "Casca/wrapper delegando para SmartCoreHub.Core.SDK.Service.Configuration.AzureADEntraIDConstants em SmartCoreHub.Core.SDK.")]
public static class AzureADEntraIDConstants
{
    ...
    public const string AzureAd =
        SmartCoreHub.Core.SDK.Service.Configuration.AzureADEntraIDConstants.AzureAd;
}
