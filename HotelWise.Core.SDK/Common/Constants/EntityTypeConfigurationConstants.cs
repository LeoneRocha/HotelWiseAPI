...
/// </summary>
[SdkWrappedSource(targetType: "SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants", targetPackage: "SmartCoreHub.Core.SDK", description: "Casca/wrapper delegando para SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants em SmartCoreHub.Core.SDK.")]
public static class EntityTypeConfigurationConstants
{
    ...
    public const string Type_Varchar_255 =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Type_Varchar_255;

    /// <summary>Tipo de coluna varchar de 40 caracteres.</summary>
    public const string Type_Varchar_40 =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Type_Varchar_40;

    /// <summary>Tipo de coluna varchar de 20 caracteres.</summary>
    public const string Type_Varchar_20 =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Type_Varchar_20;

    /// <summary>Tipo de coluna text para MySQL.</summary>
    public const string Type_Text_MySql =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Type_Text_MySql;

    /// <summary>Tipo de coluna varchar(max) para SQL Server.</summary>
    public const string Type_Text_SqlServer =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Type_Text_SqlServer;

    /// <summary>Código de idioma padrão pt-BR.</summary>
    public const string Language_Default_PTBR =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.Language_Default_PTBR;
    ...
    public const string ApplicationLanguage_ResourceKey_Default =
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.ApplicationLanguage_ResourceKey_Default;
    ...
    public static int GetMaxLengthByTypeDataBase(ETypeDataBase eTypeDataBase) =>
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.GetMaxLengthByTypeDataBase((SmartCoreHub.Core.SDK.Common.ETypeDataBase)(int)eTypeDataBase);
    ...
    public static string GetTypeTextByTypeDataBase(ETypeDataBase eTypeDataBase) =>
        SmartCoreHub.Core.SDK.Infrastructure.Data.EntityTypeConfigurationConstants.GetTypeTextByTypeDataBase((SmartCoreHub.Core.SDK.Common.ETypeDataBase)(int)eTypeDataBase);
}
