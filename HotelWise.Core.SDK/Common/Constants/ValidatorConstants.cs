...
/// </summary>
[SdkWrappedSource(targetType: "SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants", targetPackage: "SmartCoreHub.Core.SDK", description: "Casca/wrapper delegando para SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants em SmartCoreHub.Core.SDK.")]
public static class ValidatorConstants
{
    ...
    public const string NameResponseValidate_ValidatePermissionMedical =
        SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants.NameResponseValidate_ValidatePermission;

    /// <summary>Chave para mensagem de erro genérica.</summary>
    public const string GenericErroMessage =
        SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants.GenericErroMessage;
    ...
    public const string ValidateSuccessMessageKey =
        SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants.ValidateSuccessMessageKey;
    ...
    public const string ValidateSuccessMessage_Message =
        SmartCoreHub.Core.SDK.Service.Validation.ValidatorConstants.ValidateSuccessMessage_Message;
}
