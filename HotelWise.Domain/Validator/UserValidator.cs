...
/// <summary>
/// Validador FluentValidation para a entidade de usuário <see cref="User"/>, garantindo preenchimento de campos obrigatórios, regras de tamanho e integridade de e-mail.
/// </summary>
public class UserValidator : AbstractValidator<User>
{
    /// <summary>
    /// Configura as regras de validação para as propriedades do usuário.
    /// </summary>
