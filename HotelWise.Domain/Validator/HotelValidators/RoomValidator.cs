...
/// <summary>
/// Validador FluentValidation para a entidade de quarto <see cref="Room"/>, verificando existência do hotel vinculado, tipos de quarto, capacidade e regras de auditoria.
/// </summary>
public class RoomValidator : AbstractValidator<Room>
{
    ...
    /// <summary>
    /// Inicializa uma nova instância de <see cref="RoomValidator"/> injetando o repositório de hotéis.
    /// </summary>
    /// <param name="roomRepository">Repositório de quartos.</param>
    /// <param name="hotelRepository">Repositório de hotéis para verificação de chave estrangeira.</param>
    ...
    /// <summary>
    /// Método assíncrono para verificar se o HotelId informado existe no sistema.
    /// </summary>
    ...
    {
        return await _hotelRepository.ExistsAsync(h => h.Id == hotelId, cancellationToken);
    }
}
