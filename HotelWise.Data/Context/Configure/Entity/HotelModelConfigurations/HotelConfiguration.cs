...
/// <summary>
/// Mapeamento Fluent API para a entidade <see cref="Hotel"/> no MySQL, incluindo conversão de tags, relacionamentos de auditoria e seed de dados.
/// </summary>
public class HotelConfiguration : IEntityTypeConfiguration<Hotel>
{
    /// <summary>
    /// Aplica as regras de mapeamento e configuração de schema para <see cref="Hotel"/>.
    /// </summary>
