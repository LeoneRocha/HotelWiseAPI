...
/// <summary>
/// Mapeamento Fluent API para a entidade <see cref="Reservation"/> no MySQL, definindo índices de busca por quarto e períodos de estadia.
/// </summary>
public class ReservationConfiguration : IEntityTypeConfiguration<Reservation>
{
    /// <summary>
    /// Aplica as regras de mapeamento e configuração de schema para <see cref="Reservation"/>.
    /// </summary>
