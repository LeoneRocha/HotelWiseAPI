...
{
    public static class KernelProviderConfigure
    {
        public static void SetupKernelProvider(IServiceCollection services, IApplicationConfig appConfig)
        {
        ...
        private static void addTextEmbeddingGeneration(IApplicationConfig appConfig, IKernelBuilder builder)
        {
...
#pragma warning restore SKEXP0070
        ...
        private static void addAIServices(IApplicationConfig appConfig, IKernelBuilder builder)
        {
...
#pragma warning restore SKEXP0070
        ...
        private static void addVectorStores(IApplicationConfig appConfig, IKernelBuilder builder)
        {
